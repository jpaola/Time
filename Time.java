...
public class Time 
{
     ...
     */
    public Time setTime(int hr, int min, int sec) throws TimeException 
    {  
        // anticipated part of exception message in case time is illegal
     ...
     * @return a reference to the object for which the method was called
     */
    public Time setHour(int hour) throws TimeException
    {
        // anticipated part of exception message in case time is illegal
        
        String s = "\n" + hour + ":" + minute + ":" + second;
        
        // check for illegal hour
        
        if (hour > 23 || hour < 0)
        {
            throw new TimeException ( s + "\nException: The hour must range"
                 + " between 0 and 23");
        }
     ...
     * @return a reference to the object for which the method was called
     */
    public Time setMinute(int minute) throws TimeException
    {
        ...
        // check for illegal minutes
        
        if (minute > 59 || minute < 0)
        {
            throw new TimeException ( s + "\nException: Minutes must range"
                 + " between 0 and 59");
        }
     ...
     * @return a reference to the object for which the method was called
     */
    public Time setSecond(int second) throws TimeException
    {
       // anticipated part of exception message in case time is illegal
        
        String s = "\n" + hour + ":" + minute + ":" + second;
        
        // check for illegal seconds
        
        if (second > 59 || second < 0)
        {
            throw new TimeException ( s + "\nException: Seconds must range"
                 + " between 0 and 59");
        }
